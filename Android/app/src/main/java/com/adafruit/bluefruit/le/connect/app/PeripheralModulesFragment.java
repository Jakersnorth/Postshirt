...
public class PeripheralModulesFragment extends ConnectedPeripheralFragment {
    ...
    private final static int MODULE_DATACOLLECTOR = 9;
    private final static int MODULE_POSTUREDETECTOR = 10;
    ...
    private void onModuleSelected(int moduleId) {
        ...
        switch (moduleId) {
            ...
            case MODULE_DATACOLLECTOR:
                fragment = DataCollectorFragment.newInstance(singlePeripheralIdentifier);
                break;

            case MODULE_POSTUREDETECTOR:
                fragment = PostureDetectorFragment.newInstance(singlePeripheralIdentifier);
                break;
    ...
    private static class ModulesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            switch (viewType) {
                ...
                case kCellType_Module: {
                    ...
                    switch (moduleId) {
                        ...
                        case MODULE_DATACOLLECTOR:
                            iconDrawableId = R.drawable.tab_datacollector_icon;
                            titleId = R.string.datacollector_tab_title;
                            break;

                        case MODULE_POSTUREDETECTOR:
                            iconDrawableId = R.drawable.tab_posturedetector_icon;
                            titleId = R.string.posturedetector_tab_title;
                    }
        ...
        private int[] getMenuItems() {
            if (mConnectionMode == CONNECTIONMODE_MULTIPLEPERIPHERAL) {
                ...
                if (hasUart && hasDfu) {
                    return new int[]{MODULE_INFO, MODULE_UART, MODULE_PLOTTER, MODULE_PINIO, MODULE_CONTROLLER, MODULE_NEOPIXEL, /*MODULE_CALIBRATION,*/ MODULE_THERMALCAMERA, MODULE_DFU, MODULE_DATACOLLECTOR, MODULE_POSTUREDETECTOR};
                } else if (hasUart) {
                    return new int[]{MODULE_INFO, MODULE_UART, MODULE_PLOTTER, MODULE_PINIO, MODULE_CONTROLLER, /*MODULE_CALIBRATION, */MODULE_THERMALCAMERA, MODULE_DATACOLLECTOR, MODULE_POSTUREDETECTOR};
                } else if (hasDfu) {
